...
- **2026:** choppy. Decent Feb (16 km long run, 4:07/km tempo). Mar 22 – May 2: near-zero (6-week gap). Rebuilt May–Jun to ~10–15 mi/wk. Jul 4: build begins, CTL ~19. Jul 26 – Aug 15: a second near-total gap (busy stretch/travel, incl. a trip to Copenhagen in early Aug) — CTL fell from ~30 to ~21, nearly zero running for three weeks. Aug 16 – Aug 30: aggressive rebuild, CTL 22→34.5 in two weeks, rampRate held +4.0–4.5/wk (above the healthy +1–2.5) for the whole stretch; nine of the last thirteen training days through Aug 30 sat at ≥80% intensity (only Aug 31 and odd short pieces genuinely easy), capped by a 21.1 km run at 90.7% intensity (load 141) on Aug 30 — a second boom-bust cycle inside the same build the plan was designed to prevent. As of Sep 1: CTL 32.9, ATL 44.6, form −11.7.
...
**Checkpoint reality check (as of Sep 1, 2026):** criterion (a) is already unreachable for this pass — the Jul 26–Aug 15 gap means there is no 8-week window of uninterrupted training that ends at Sep 5–7, regardless of what happens in the final days before it. The 1:20 dream cannot pass this checkpoint on the calendar alone. Treat Sep 5–7 as confirming the 1:24–1:27 commitment rather than as a live 1:20 gate, and do not let a strong number on any single remaining criterion (volume is on pace; a 21.1 km run landed Aug 30) argue otherwise — the gate is ALL-of, not most-of. The higher-value question this checkpoint should actually ask: is the Aug 16–30 rebuild (nine of thirteen days at ≥80% intensity, rampRate +4–4.5/wk) about to reproduce the exact pattern that produced the Jul 26 gap in the first place.
