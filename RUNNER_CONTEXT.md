...
**Personality (from data + conversation):** highly capable, competitive, habit-driven, pace-ego is real — resists easy paces ("really slow"), anchors on glory-days paces (long runs near 4:00–4:22/km in 2022), negotiates upward on intensity. **Confirmed in practice (Jul 5, 2026): negotiated the prescribed long run from 6:30 → 5:45/km, then averaged 5:24 — start was on-prescription, drift came in the back half. Expect prescribed easy paces to erode 20–30 s/km as runs progress; the failure mode is holding the ceiling late, not the start.** Responds to data-based arguments and honest math; own-telemetry evidence (e.g., decoupling) lands better than principles. Coaching approach that works: hold the line on principles, show the math from his own history, offer explicit tradeoff options ("Option A vs B with the bill attached"), give him ownership of the final call. **Consistency risk = life-schedule crunch, not motivation or body:** the Mar 22 – May 2, 2026 gap was a busy stretch at work; a second gap Jul 27 – Aug 7 (11 days, confirmed as travel) followed directly on a two-day intensity spike (track session + a long run held well over its HR ceiling) that pushed form to −20.0 — the boom immediately preceding the bust, exactly the pattern that has ended every prior build. post-Oct 2026 life gets significantly busier. Plans must survive busy weeks — short easy runs > perfect weeks; protect social anchors (Tue run club).
...
- **2026:** choppy. Decent Feb (16 km long run, 4:07/km tempo). Mar 22 – May 2: near-zero (6-week gap). Rebuilt May–Jun to ~10–15 mi/wk. Built through July to CTL 30.0 (Jul 26, best of this cycle). **Jul 25–26: a track session (7×~400m into Z5) immediately followed by a 20 km long run held at 5:07/km throughout (HR ceiling 148 breached from km2, ~5.5% decoupling) — two consecutive prescription violations, pushing form to −20.0, the build's worst reading. Jul 27–Aug 7: an 11-day total stoppage followed (one 52-min walk in Copenhagen on Aug 4 the only activity), confirmed as travel rather than injury/illness. CTL fell back to 22.2 by Aug 8, essentially erasing three weeks of the July build.** This is the same boom-bust shape as 2022/2023/spring-2024, recurring within the same month it was explicitly flagged (see Jul 19–24 log entries) — see §3 and the Aug 8 log entry for the restart plan.
