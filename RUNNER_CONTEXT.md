...
- **2026:** choppy. Decent Feb (16 km long run, 4:07/km tempo). Mar 22 – May 2: near-zero (6-week gap). Rebuilt May–Jun to ~10–15 mi/wk. Jul 4 – Jul 26: cleanest block of the build, CTL 19→30.0, capped by a 20.01 km long run (Jul 26, longest of the build, decoupling 4.6%). **Jul 27 – Aug 9: a second 14-day near-zero gap (travel; one easy walk logged Aug 4), CTL back down to 21.7 by Aug 9 — no injury/illness signal, recovery metrics stayed excellent throughout (HRV peaked 121 ms), but real fitness was lost.** The return (Aug 10–12) ran hot three days straight — a progression to 94.7% max HR, a club night with a sub-5K-pace effort at 98% max HR against explicit guidance not to, and a "recovery" run to 92.6% max HR on an amber morning (HRV 71–73, RHR 50–53, both still off baseline) — landing the athlete back in a real fatigue hole two days after the block reopened. Aug 13: prescribed full rest, non-negotiable, pending HRV/RHR recovery.
