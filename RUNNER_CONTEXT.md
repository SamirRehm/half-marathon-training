...
- **2026:** choppy. Decent Feb (16 km long run, 4:07/km tempo). Mar 22 – May 2: near-zero (6-week gap). Rebuilt May–Jun to ~10–15 mi/wk. Jul 2026: base rebuild going well (CTL 19→30 in 3 weeks), until Jul 26 — a 20.0 km continuous run at steady/moderate effort (64% Z3, only ~4% decoupling), a 67% jump over the prior longest run this build with no build-up week, the single biggest one-day load spike logged (119 TSS). Immediately followed by a ~2-week near-total training gap (Jul 27–Aug 9; one easy walk logged Aug 4, location Copenhagen). Wellness through the gap read as well-rested throughout (HRV mostly 85–121 vs the ~87 baseline, RHR mostly low-40s) rather than depleted — consistent with travel rather than injury or illness, though the cause was never logged. CTL fell 30→~22 over the gap. Training resumed Aug 10–11 with a hard-shaped return (Mon: continuous progression to Z5 on day one back; Tue: club night with 9.6 min at Z6/Z7 including a 98%-max-HR closing rep, 2nd day back, no graduated re-entry) — the chronic-over-intensity + boom-bust pattern (§3) recurring in a new shape: this time the crash was a life-schedule gap rather than an injury, but the entry into and exit out of it were both abrupt. (doc: 2026-08-12 backfill, scoring Jul 25–Aug 11.)
