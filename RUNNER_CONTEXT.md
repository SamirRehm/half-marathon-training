...
- **2026:** choppy. Decent Feb (16 km long run, 4:07/km tempo). Mar 22 – May 2: near-zero (6-week gap). Rebuilt May–Jun to ~10–15 mi/wk, CTL to 30.0 by Jul 26 (best reading of the build). Jul 27 – Aug 9: second gap (14 days, travel), CTL back down to ~21 by Aug 9–10.
...
**Update (Aug 10, 2026): criterion (a) already failed.** The Jul 27 – Aug 9 travel gap broke the "8+ consecutive weeks with no interruption" requirement outright, with the Sep 5–7 checkpoint only ~3.5 weeks out and CTL reset to ~21. Treat the 1:20 Labor Day gate as closed for this cycle without needing to wait for the checkpoint date — the arithmetic that was already an outer edge in July cannot recover the lost weeks. This does not touch the 1:24–1:27 committed goal, which remains reachable on a disciplined restart (short easy re-entry, rebuild volume before any quality resumes) — see the daily log Aug 10 entry for the restart plan.
