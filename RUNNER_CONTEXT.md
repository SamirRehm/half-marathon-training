...
**Personality (from data + conversation):** highly capable, competitive, habit-driven, pace-ego is real — resists easy paces ("really slow"), anchors on glory-days paces (long runs near 4:00–4:22/km in 2022), negotiates upward on intensity. **Confirmed in practice (Jul 5, 2026): negotiated the prescribed long run from 6:30 → 5:45/km, then averaged 5:24 — start was on-prescription, drift came in the back half. Expect prescribed easy paces to erode 20–30 s/km as runs progress; the failure mode is holding the ceiling late, not the start.** Responds to data-based arguments and honest math; own-telemetry evidence (e.g., decoupling) lands better than principles. Coaching approach that works: hold the line on principles, show the math from his own history, offer explicit tradeoff options ("Option A vs B with the bill attached"), give him ownership of the final call. **Consistency risk = life-schedule crunch, not motivation or body:** the Mar 22 – May 2, 2026 gap was a busy stretch at work; a second gap, Jul 27 – Aug 3, 2026 (confirmed by a Copenhagen-tagged activity Aug 4), was travel — so the risk class is broader than work alone. Post-Oct 2026 life gets significantly busier. Plans must survive busy weeks and travel — short easy runs > perfect weeks; protect social anchors (Tue run club), though both Tuesdays inside the Jul 27–Aug 4 gap were missed. **Gate/ceiling instructions do not reliably survive contact even immediately after an enforced correction:** Jul 24's forced rest day (taken specifically to unwind an over-intensity week) was followed by Jul 25's Saturday track session at 94.7% max HR against a prescribed easy-148-ceiling day and explicitly-closed tempo gates, then Jul 26's 20 km long run at 5:07/km against a prescribed 5:50–6:05/km — both violations landed within 48 hours of the rest day meant to prevent them. Written pace/HR ceilings alone are not sufficient; expect them to be tested even right after a correction.
