...
- **Jul–Aug 2026:** CTL rose 27.8 (Jul 25) → ~31 (Aug 28), with two long runs at 19.6–20 km (Jul 26, Aug 23) — the build's longest runs so far, ahead of the "16–18 km routine" Labor Day criterion. But a ~10-day near-zero stretch (travel, early Aug) interrupted it, and the intensity-heavy/easy-deficient pattern reasserted itself on return: essentially every session Aug 10–27 ran 82–108% intensity, ramp held above +4/wk for over a week, and form bottomed at −20.4 (Aug 27 evening) before a rest day. **`data/daily_log.json` has no entries between 2026-07-26 and 2026-08-28 — the daily routine did not run in that window** (confirmed against Intervals: real training continued throughout; only the logging stopped). One manual backfill (Jul 25) ran Aug 23. Logging resumed 2026-08-29; the gap itself is not backfilled — treat the dashboard as having a blind month with real, unlogged over-intensity risk in it, right before the Labor Day checkpoint.
