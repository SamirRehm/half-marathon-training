...
*(2026-09-12 note: the coaching routine went dark 2026-07-26 through 2026-09-11 — the Intervals.icu connector hit its free-plan call quota — and only 2026-07-26 has been re-scored so far; the rest of that window is real, unscored training pending the stream backfill. Raw wellness shows CTL climbed ~20 → ~34 over the gap, genuine fitness gained. But nothing in the available activity summaries for the Sep 5–7 window looks like a 10K TT or race — if that holds once the backlog is read in full, checkpoint criterion (c) was very likely not met, which would formally commit the race at 1:24–1:27. Needs athlete confirmation: was a TT or race run in that window that isn't obvious from activity names alone?)*
