...
- **2026:** choppy. Decent Feb (16 km long run, 4:07/km tempo). Mar 22 – May 2: near-zero (6-week gap). Rebuilt May–Jun to ~10–15 mi/wk. Jul 4: CTL ~19, ATL ~27 (form ≈ −8). Jul 25–26: block-peak weekend (max-effort 7x400m track session Sat, then a 20 km continuous long run Sun run 45–58 s/km hotter than prescribed with the HR ceiling breached almost the entire way; CTL touched a block-high 30.0). **Jul 27–Aug 3: nine-day complete stoppage** immediately following — cause not established in the log (no comments/notes on file; wellness through the gap shows a well-rested body, not an illness or overtraining signature — HRV rose as high as 121 against an ~87 baseline and resting HR fell to 41, both in the favourable direction, with one outlier night Jul 30 at 2h29m/score 33). CTL fell from the 30.0 peak to 24.2 by Aug 4, unwinding roughly three weeks of the build. Training resumed Aug 4 with a short, easy, conditional test run rather than the normal Tuesday club slot. This is the third boom-bust cycle on record for this exact shape — a hard weekend immediately followed by a multi-day-or-longer stoppage — after the pattern that preceded the 2022/2023 collapses; see §3.
