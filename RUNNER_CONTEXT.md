...
- **2026:** choppy. Decent Feb (16 km long run, 4:07/km tempo). Mar 22 – May 2: near-zero (6-week gap). Rebuilt May–Jun to ~10–15 mi/wk. Jul 4–24: cleanest stretch of the build, CTL 19→28. **Jul 25–26: the pattern repeated at the build's largest scale yet** — an unauthorized track effort (Sat, tempo gates not open) immediately followed by a 20 km long run run entirely hot (never on the prescribed 5:50–6:05/km, HR breached the 148 ceiling by km 6 and stayed there, one-way HR drift 138→167 while pace got faster not slower), pushing form to −20.0, the block's worst reading. **Jul 27 – Aug 8: 13 consecutive days with zero runs logged** (one Copenhagen walk Aug 4 — partial travel context, but the gap starts 8 days before that and is otherwise unexplained; no illness/injury flagged in wellness). CTL fell 30.0 → 22.2 over the gap. No cause is confirmed in the data, but the shape — overreaching weekend followed by total stoppage — matches the 2022/2023/Mar–Apr-2026 collapses exactly. Aug 9: restart prescribed as a fresh re-entry (easy-only, short duration), CTL 21.7.
...
**Update Aug 9, 2026: the Jul 27–Aug 8 gap (13 days, zero runs) already fails this checkpoint on the data.** Criterion (a) needed 8 consecutive interruption-free weeks by Sep 5–7; this gap sits inside that window and cannot be undone retroactively. Criterion (b) — 35–38 mi/wk with 16–18 km long runs routine — is not reachable from a restart with under five weeks left. **Treat 1:20 as settled at 1:24–1:27 committed, without waiting for the formal Labor Day check-in**, and do not re-open it on a strong week or two — the arithmetic, not the mood of any given week, is what closed it. The committed goal itself is intact in principle (12 weeks to Oct 31 from the Aug 9 restart is enough to rebuild toward 1:24–1:27) but has less runway than the original plan assumed; the restart should be treated as a fresh base re-entry (see the Jul 4 skeleton), not a resumption of the interrupted build's volume.
