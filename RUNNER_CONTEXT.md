...
- **Jul 25–26, 2026: the boom-bust pattern recurred inside this build.** A track session prescribed as easy 50–60 min ran instead as 7×~400 m continuous at 94–102% of threshold (HR to 180, 95% max); the next evening's long run, prescribed 100–110 min @ 5:50–6:05/km with a 148 HR ceiling, ran the full 20.0 km at 5:07/km (43–58 s/km hot) with HR above ceiling almost the entire way — two hard days back to back, ATL peaking at 50.0 (the block's worst reading). Jul 27–Aug 5: a 9-day gap with no running (one 52-min Copenhagen walk on Aug 4, coinciding with international travel from ~Jul 30), CTL fell from 30.0 to 23.3. Confirms §3's "every previous build ends in a crash" is not purely historical — it reproduced in real time at CTL ~30, far short of peak volume, which argues for treating the Saturday-tempo gates and quality-budget rules as load-bearing, not advisory, well before the numbers alone would suggest risk. Aug 6 restart treated as base re-entry, not a resumed build.
